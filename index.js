...
bot.use('command','test',(msg, next) => {
	console.log('command'.green,': ',msg.command.yellow)
})
...
bot.use('entities_me', msg => {
	console.log('entities_me',msg.entitiesFor, msg.entitiesMe)
})
...
// //   bot.api.sendMessage(chatId, 'Received your message');
// });
